...
void entity_move_handler(bot_t *bot, 
        vint32_t entity_id,
        int8_t dx,
        int8_t dy,
        int8_t dz,
...
void entity_status_handler(bot_t *bot,
        int32_t entity_id,
        int8_t status)
{
...
bot_t *init_defender(char *name, char *server_name, int port)
{
    ...
    register_play_clientbound_update_health(bot, respawn_handler);
